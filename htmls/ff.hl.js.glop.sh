...
if [[ -z "$1" ]]; then
		#PATHDIRHOME="/home/fly/scripts/htmls/VAULT/lab/mediaelement"
		PATHDIRHOME="$PWD"
	else
		PATHDIRHOME="$1"
fi
...
# 				tar -jxvf /home/fly/scripts/htmls/VAULT/jsc-build.tar.gz
# #				mkdir -p $PATHDIRHOME/jsc/{js,css}
# #				mkdir -p jsc/js/custom
# #				mkdir -p jsc/css/custom
# 				cp "/home/fly/scripts/htmls/VAULT/bootstrap.min.js.txt" "$PATHDIRHOME/jsc/js/custom/bootstrap.min.js"
